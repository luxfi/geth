...
import (
	...
	corethPrometheus "github.com/luxfi/geth/metrics/prometheus"
	...
	warpPrecompile "github.com/luxfi/geth/precompile/contracts/warp"
...
func (vm *VM) Initialize(
	...
	if g.Config.ChainID.Cmp(params.LuxLocalChainID) != 0 {
