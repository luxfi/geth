...
// https://github.com/luxfi/geth/pull/15549.
...
// See https://github.com/luxfi/geth/pull/15225#issuecomment-380191512
...
//
// See https://github.com/luxfi/geth/issues/20106.
...
func TestDeleteStorage(t *testing.T) {
	...
	_, _, fastNodes, err := fastState.deleteStorage(addr, common.Hash(crypto.Keccak256Hash(addr[:])), storageRoot)
	if err != nil {
		t.Fatal(err)
	}

	_, _, slowNodes, err := slowState.deleteStorage(addr, common.Hash(crypto.Keccak256Hash(addr[:])), storageRoot)
	if err != nil {
		t.Fatal(err)
	}
