...
func fakeBlockHash(txh common.Hash) common.Hash {
	return common.Keccak256Hash([]byte("testblock"), txh.Bytes())
}
...
func TestSignTransaction(t *testing.T) {
	...
	var (
		...
		to      = common.PubkeyToAddress(key.PublicKey)
		genesis = &core.Genesis{
			Config: params.MergedTestChainConfig,
			Alloc:  types.GenesisAlloc{},
		}
...
func TestRPCGetBlockOrHeader(t *testing.T) {
	...
	var (
		...
		acc1Addr   = common.PubkeyToAddress(acc1Key.PublicKey)
		acc2Addr   = common.PubkeyToAddress(acc2Key.PublicKey)
		genesis    = &core.Genesis{
			Config: params.TestChainConfig,
			Alloc: types.GenesisAlloc{
