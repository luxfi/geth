...
func TestAccountIteratorTraversal(t *testing.T) {
	...
	it := newDiffAccountIterator(common.Hash{}, head.(*diffLayer).states.accountList(), nil)
...
func TestStorageIteratorTraversal(t *testing.T) {
	...
	diffIter := newDiffStorageIterator(common.HexToHash("0xaa"), common.Hash{}, head.(*diffLayer).states.storageList(common.HexToHash("0xaa")), nil)
...
func TestAccountIteratorLargeTraversal(t *testing.T) {
	...
	verifyIterator(t, 200, newDiffAccountIterator(common.Hash{}, head.(*diffLayer).states.accountList(), nil), verifyNothing)
