...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/luxfi/geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/luxfi/geth/internal/version.gitDate="+env.Date)
	}
	...
	// NOTE:gballet): revisit after the input api has been defined
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/luxfi/geth/core/rawdb", "github.com/luxfi/geth/ethdb/leveldb"},
		{"github.com/luxfi/geth/core/rawdb", "github.com/luxfi/geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
